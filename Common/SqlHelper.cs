...
namespace ZGZY.Common
{
    ...
    {
        //读取配置文件里的数据库连接字符串
        public static readonly string connStr = ConfigurationManager.ConnectionStrings["conn"].ToString(); //"server=.;uid=GTB2;pwd=Cy2508505;database=GTB"; // 
        ...
        /// 执行增删改【常用】
        /// </summary>
        public static int ExecuteNonQuery(string connStr, CommandType commandType, string commandText, params SqlParameter[] paras)
        {
        ...
        public static int ExecuteNonQuery(string connStr, List<string> listSql)
        {
            SqlCommand cmd = new SqlCommand();
        ...
        /// 返回DataReader对象
        /// </summary>
        public static SqlDataReader ExecuteReader(string connStr, CommandType commandType, string cmdText, params SqlParameter[] paras)
        {
            SqlCommand cmd = new SqlCommand();
            SqlConnection conn = new SqlConnection(connStr);
            try
        ...
        /// </summary>
        public static object ExecuteScalar(string connStr, CommandType commandType, string commandText, params SqlParameter[] paras)
        {
            SqlCommand cmd = new SqlCommand();
        ...
        /// 返回DataTable
        /// </summary>
        public static DataTable GetDataTable(string connStr, CommandType commandType, string commandText, params SqlParameter[] paras)
        {
            SqlCommand cmd = new SqlCommand();
            using (SqlConnection conn = new SqlConnection(connStr))
            {
        ...
        /// 返回DataSet
        /// </summary>
        public static DataSet GetDataset(string connStr, CommandType commandType, string commandText, params SqlParameter[] paras)
        {
            SqlCommand cmd = new SqlCommand();
            using (SqlConnection conn = new SqlConnection(connStr))
            {
